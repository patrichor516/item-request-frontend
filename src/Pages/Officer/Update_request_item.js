...
function Update_request_item() {
  ...
  const fetchItemData = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/request/${requestId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`http://localhost:8000/api/auth/update/request/${requestId}`, {
        user_id: userId,
        item_name: itemName,
        quantity: quantity,
        status: status,
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-body">
                      <h5 className="card-title">Update Request Item</h5>
...
export default Update_request_item;
